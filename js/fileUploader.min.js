...
i.readAsDataURL(t),i.onload=function(t){FileUploader.Image.changeCanvas(t,e,a,!0)}})},changeVideo:function(e){var a=$(e).attr("id"),t=$(e).prev(),i=FileUploader.Files.getFile(a),n=window.URL||window.webkitURL,r=n.createObjectURL(i)
...
s.clearRect(0,0,a.width,a.height),s.drawImage(e,l,d,o,r)},changeCanvas:function(e,a,t,i){i=i||!1
var n=$(a).prev().attr("id")
$("#"+n).css({transform:""})
var r=new Image
r.src=e.target.result,r.onload=function(){var e=document.getElementById(n)
FileUploader.Image.resizeImage(r,e),FileUploader.Image.rotate(n,t),$(a).parent().attr("data-changed",1),i&&$(a).parent().trigger("fileUploaderChange")}},getOrientation:function(e,a){var t=new FileReader
...
r.src=t.defaultImage,r.onload=function(t){var i=document.getElementById(n)
FileUploader.Image.resizeImage(r,i),e(a).parent().trigger("fileUploaderChange")}}}},load:function(a,t){void 0!==e(a).data("loaded")&&null!==e(a).data("loaded")||(e(a).attr("data-loaded",1),r.Makers.appendElements(a,t),r.Makers.addClickEvents(a,t),r.Makers.setDefaultImage(a,t))}}
